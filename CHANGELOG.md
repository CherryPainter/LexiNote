...
## v1.9.0 - 2025-11-01
### Added
- 实现了单词学习批次管理功能，添加了adjust_batch_size方法
...
- 为AI助手页面添加异步处理，避免UI阻塞
### Fixed
- 修复词库管理问题：1) 移除get_all_word_sets的缓存装饰器，解决新建词库不显示问题；2) 增加词库列表宽度，优化显示效果
- 修复execute_write方法参数类型问题，解决'parameters are of unsupported type'错误
